...
#
	...
	setup(name = "pas_http_tasks",
	      version = get_version(),
	      description = "Python Application Services",
	      long_description = """"pas_http_tasks" provides support to execute tasks based on external access e.g. for verification.""",
	      author = "direct Netware Group",
	      author_email = "web@direct-netware.de",
	      license = "GPLv2+",
	      url = "https://www.direct-netware.de/redirect?pas;http;tasks",
